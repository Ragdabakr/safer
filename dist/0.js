...
var BookingService = /** @class */ (function () {
    ...
    BookingService.prototype.createBooking = function (data) {
        debugger;
        return this.http.post('/api/v1/bookings', { data: data });
    };
    ...
    BookingService.prototype.updateTourCompleted = function (id, data) {
        debugger;
        return this.http.patch("/api/v1/tours/" + id, { data: data });
    };
    BookingService.prototype.bookingMonthlyStatus = function (year) {
        return this.http.get("/api/v1/bookings/monthly-plan/" + year);
    };
    BookingService.prototype.bookingWeeklyStatus = function () {
        return this.http.get('/api/v1/bookings/weekly-plan/week');
    };
    BookingService.prototype.getRemainingSeatsPlan = function () {
...
var InvoiceService = /** @class */ (function () {
    ...
    InvoiceService.prototype.createInvoice = function (data) {
        debugger;
        return this.http.post('/api/v1/invoices', { data: data });
    };
    InvoiceService.prototype.getInvoices = function () {
        debugger;
        return this.http.get('/api/v1/invoices');
    };
    InvoiceService.prototype.editInvoice = function (id, data) {
        debugger;
        return this.http.patch("/api/v1/invoices/" + id, { data: data });
    };
...
var TourService = /** @class */ (function () {
    ...
    TourService.prototype.getCountries = function () {
        return this.http.get('/api/v1/lookups/countries');
    };
    TourService.prototype.sendProfileImage = function (image) {
        debugger;
    ...
    //Buses Section
    TourService.prototype.getBuses = function () {
        debugger;
        return this.http.get('/api/v1/buses');
    };
    TourService.prototype.createBus = function (data) {
        debugger;
        return this.http.post('/api/v1/buses', { data: data });
    };
    TourService.prototype.deleteBus = function (deleteId) {
        debugger;
        return this.http.delete("/api/v1/buses/" + deleteId);
    };
    TourService.prototype.updateBus = function (data, editId) {
        debugger;
        return this.http.patch("/api/v1/buses/" + editId, { data: data });
    };
    //HotelsSection
    TourService.prototype.getHotels = function () {
        return this.http.get('/api/v1/hotels');
    };
    TourService.prototype.createHotel = function (data) {
        debugger;
        return this.http.post('/api/v1/hotels', { data: data });
    };
    TourService.prototype.deleteHotel = function (deleteId) {
        debugger;
        return this.http.delete("/api/v1/hotels/" + deleteId);
    };
    TourService.prototype.updateHotel = function (data, editId) {
        debugger;
    ...
    //ToursSection
    TourService.prototype.createTour = function (data) {
        debugger;
        return this.http.post('/api/v1/tours', { data: data });
    };
    TourService.prototype.getTours = function () {
        return this.http.get('/api/v1/tours');
    };
    TourService.prototype.getTourById = function (id) {
        debugger;
        return this.http.get("/api/v1/tours/" + id);
    };
    TourService.prototype.editTour = function (id, data) {
        debugger;
        return this.http.patch("/api/v1/tours/" + id, { data: data });
    };
    TourService.prototype.editTourInformation = function (id, data, guideId) {
        debugger;
        return this.http.patch("/api/v1/tours/tourInformation/" + id, { data: data, guideId: guideId });
    };
    TourService.prototype.editDate = function (id, date, dateId) {
        debugger;
        return this.http.patch("/api/v1/tours/tourdate/" + id, { date: date, dateId: dateId });
    };
    TourService.prototype.deleteDate = function (id, dateId) {
        debugger;
        return this.http.post("/api/v1/tours/deleteTourdate/" + id, { dateId: dateId });
    };
    TourService.prototype.addNewDate = function (id, date) {
        debugger;
        return this.http.post("/api/v1/tours/addTourdate/" + id, { date: date });
    };
    TourService.prototype.editLocation = function (id, location, locationId) {
        debugger;
        return this.http.patch("/api/v1/tours/tripLocations/" + id, { location: location, locationId: locationId });
    };
    TourService.prototype.addTourTripLocations = function (id, tripLocation) {
        debugger;
        return this.http.post("/api/v1/tours/addTripLocations/" + id, { tripLocation: tripLocation });
    };
    TourService.prototype.deleteTripLocation = function (id, locationId) {
        debugger;
        return this.http.post("/api/v1/tours/deleteTripLocations/" + id, { locationId: locationId });
    };
    TourService.prototype.deleteTourImage = function (id, imageId) {
        debugger;
        return this.http.post("/api/v1/tours/deleteTourImage/" + id, { imageId: imageId });
    };
    TourService.prototype.addTourImage = function (id, data) {
        debugger;
        return this.http.post("/api/v1/tours/addTourImage/" + id, { data: data });
    };
    TourService.prototype.updateTourCoverImage = function (id, data) {
        debugger;
        return this.http.post("/api/v1/tours/updateTourCoverImage/" + id, { data: data });
    };
    TourService.prototype.enableTour = function (id, data) {
        debugger;
        return this.http.patch("/api/v1/tours/enableTour/" + id, { data: data });
    };
    ...
    TourService.prototype.tourMonthlyStatus = function (year) {
        return this.http.get("/api/v1/tours/monthly-plan/" + year);
    };
    TourService.prototype.tourWeeklyStatus = function (year) {
        return this.http.get("/api/v1/tours/weekly-plan/" + year);
    };
    TourService.prototype.tourCompletedStatus = function () {
        return this.http.get('/api/v1/tours/tour-completed-stats');
    };
    TourService.prototype.tourDiffcultyStatus = function () {
        return this.http.get('/api/v1/tours/tour-diffculty-stats');
    };
    TourService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
